...
def parse_args():
    ...
    parser.add_argument('--checkpoint', type=str, default='./save_res_0101_D2se', help='checkpoint save pth')
    ...
    parser.add_argument('--data_dir', type=str, default='./HRSC2016', help='Data directory')
